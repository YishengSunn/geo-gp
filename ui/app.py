...
PHI0_K_REF = CFG.anchor['phi0_k_ref']                              # Number of initial points used to estimate phi0 (consistent with multi-track version)
PHI0_K_PROBE = CFG.anchor['phi0_k_probe']                          # Number of initial points used to estimate phi0 (consistent with multi-track version)
